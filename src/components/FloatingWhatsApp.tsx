...
export const FloatingWhatsApp = () => {
  return (
    ...
    >
      {/* Tooltip/Label */}
      <span className="mr-3 px-4 py-2 bg-white text-charcoal font-sans font-bold text-sm rounded-full shadow-xl opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none border border-charcoal/5">
        Chat with us
      </span>
